...
CIRCUIT_NAME=proof_more_efficient
...
# start=`date +%s`
# yarn snarkjs zkey contribute -verbose "$CIRCUIT_NAME"_0.zkey "$CIRCUIT_NAME".zkey -n="First phase2 contribution" -e="some random text 5555" > contribute.out
# end=`date +%s`
# echo "DONE ($((end-start))s)"
