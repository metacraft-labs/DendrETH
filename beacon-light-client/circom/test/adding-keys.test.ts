...
describe('Add public keys test', () => {
  it('Test1', async () => {
    const a = PointG1.fromHex(
      'a7ecfb69d8c08ee7c4155ac69adda7393593e6614b349cf83e07586a2b3fce780a54ecf31f1536b35f428a4f75263ac0',
    );
    const b = PointG1.fromHex(
      'a1c78c5cf35f1a5b398ce01a7b2b3333d59886e68e257d8eb06a3e893456a8b2d201a5285a0653285bdabef409a0859a',
    );
    const add = a.add(b);
