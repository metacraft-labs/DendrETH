use anyhow::Result;
use ark_bls12_381::{Bls12_381, Fq, Fq2, G1Affine, G1Projective, G2Affine};
...
async fn async_main() -> Result<()> {
    ...
    let circuit_data = load_circuit_data_starky(&format!("{CIRCUIT_DIR}/bls12_381"));
    let target_bytes = read_from_file(&format!("{}/{}.plonky2_targets", CIRCUIT_DIR, "bls12_381"))?;
