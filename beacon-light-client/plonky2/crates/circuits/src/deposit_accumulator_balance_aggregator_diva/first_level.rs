use crate::{
    common_targets::{DepositTargetsDiva, Sha256MerkleBranchTarget},
...
pub struct DepositAccumulatorBalanceAggregatorDivaFirstLevelTargets {
    #[target(in)]
    ...
    #[target(in)]
    pub deposit: DepositTargetsDiva,
    ...
    #[target(out)]
    pub deposit_hash_tree_root: HashOutTarget,
...
impl Circuit for DepositAccumulatorBalanceAggregatorDivaFirstLevel {
    ...
    type Target = DepositAccumulatorBalanceAggregatorDivaFirstLevelTargets;
    ...
    fn define(
        ...
        let deposit_hash_tree_root = HashOutTarget {
...
mod test {
    ...
    #[test]
    pub fn test_deposit_accumulator_diva_leaf_circuit() {
        ...
        assert_eq!(
            result.commitment_mapper_root.0,
            [
                9598574192830158314,
        ...
        assert_ne!(result.deposit_hash_tree_root.0, [0, 0, 0, 0]);
    }
    ...
    pub fn test_deposit_accumulator_diva_leaf_circuit_different_pubkeys() {
        ...
        json_input.deposit.pubkey[253] = true;
    ...
    #[test]
    #[should_panic]
    pub fn test_deposit_accumulator_diva_leaf_circuit_wrong_commitment_mapper_proof() {
        let json_str = read_file_to_string().unwrap();
        let mut json_input = serde_json::from_str::<
            CircuitInput<DepositAccumulatorBalanceAggregatorDivaFirstLevel>,
        >(&json_str)
        ...
        json_input.commitment_mapper_proof[0].0[0] = 14253833605643055269;
    ...
    pub fn test_deposit_accumulator_diva_leaf_circuit_wrong_balances_root() {
        ...
        json_input.balance_proof[0].0[123] = true;
    ...
    pub fn test_deposit_accumulator_diva_leaf_circuit_is_dummy() {
        ...
        assert_eq!(result.deposit_hash_tree_root.0, [0, 0, 0, 0]);
    }
