...
impl Circuit for DepositAccumulatorBalanceAggregatorInnerLevel {
    ...
    fn define(
        ...
        let deposit_hash_tree_root = poseidon_pair(
            builder,
            l_input.deposit_hash_tree_root,
            r_input.deposit_hash_tree_root,
        );
        ...
        let output_targets =
            CircuitOutputTarget::<DepositAccumulatorBalanceAggregatorDivaFirstLevel> {
                ...
                commitment_mapper_root: l_input.commitment_mapper_root,
            };
...
fn connect_pass_through_data<F: RichField + Extendable<D>, const D: usize>(
    ...
    builder.connect_hashes(
        l_input.commitment_mapper_root,
        r_input.commitment_mapper_root,
    );
