use plonky2::{hash::hash_types::RichField, field::extension::Extendable, plonk::circuit_builder::CircuitBuilder, iop::target::BoolTarget};

use crate::{utils::{bits_to_biguint_target, biguint_to_bits_target}, biguint::CircuitBuilderBiguint};
