...
use crate::{
    ...
    utils::{
        biguint::CircuitBuilderBiguint, hashing::sha256::make_circuits, utils::ETH_SHA256_BIT_SIZE,
    },
    withdrawal_credentials_balance_aggregator::build_validator_balance_circuit::{
