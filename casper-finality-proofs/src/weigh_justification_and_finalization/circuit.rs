...
use crate::types::{BeaconStateLeafProof, Gwei, MerkleProof, Root, Slot};
use plonky2x::{
    ...
    fn define<L: PlonkParameters<D>, const D: usize>(builder: &mut CircuitBuilder<L, D>) {
        ...
        let (new_current_justified_checkpoint, new_justification_bits) = process_justifications(
            ...
            CheckpointVariable {
                ...
                root: previous_epoch_start_slot_root_in_block_roots,
            },
            CheckpointVariable {
                epoch: current_epoch,
                root: current_epoch_start_slot_root_in_block_roots,
            },
        );
