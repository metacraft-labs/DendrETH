...
use plonky2x::prelude::{
    ArrayVariable, CircuitBuilder, PlonkParameters,U64Variable,
};
...
impl CountUniqueValidators {
            ...
            plonky2::plonk::config::AlgebraicHasher<<L as PlonkParameters<D>>::Field>,
    {
        ...
        let validator_indices = builder.read::<ArrayVariable<U64Variable, VALIDATOR_INDICES_IN_SPLIT>>();
        ...
        assert_is_true(builder, set_is_ordered_pred);
